            ...
            <div class="row gap-3 px-2 mt-4">
                <div v-for="restaurant in restaurants" :key="restaurant.id"
                    ...
                    <div class="rounded overflow-auto ratio ratio-4x3">
                        <img :src="'Storage/' + restaurant.img" alt="" class="w-100 h-100" style="object-fit: cover;">
                    </div>
                    <div class="p-3 text-start">
                        ...
                        <div class="d-flex align-items-center justify-content-between">
                            <div class="d-flex align-items-center">
                                <p class="text-orange pb-0 pe-1">€{{restaurant.delivery_price}}</p>
                            ...
                            <router-link :to="restaurant.slug" class="btn btn-primary">Visita</router-link>
                        </div>
                    </div>
                </div>
            </div>
