    ...
    <div class="search-section bg-primary">
        <div class="container py-3">
            <div
                ...
                class="category-jumbo m-auto mb-3"
                style="max-width: 300px"
            >
                <img
                    :src="'/images/categories/' + jumbo"
                    alt=""
                    class="w-100"
                />
            </div>
            ...
            <div class="dropdown dropdown-center mb-2">
                <a
                    ...
                    aria-expanded="false"
                >
                    <i class="fa fa-solid fa-search pe-3"></i>
            ...
            <div class="mx-auto">
                <ul
                    class="categories-container text-start gap-2 justify-content-evenly"
                >
                    <li
                        data-aos="zoom-in"
                        data-aos-easing="ease-in-out"
                        data-aos-duration="300"
                        v-for="(list, i) in selectedCategories"
                        :key="list"
                        class="list-unstyled d-inline-block bg-sand categories-style px-3 py-1 me-1 mb-2 text-nowrap"
                    >
                        {{ list }}
                        <span
                            data-aos="zoom-in"
        ...
        clearCategory(category) {
            ...
            for (let i = 0; i < newRestaurants.length; i++) {
                for (let j = 0; j < newCateg.length; j++) {
                    for (
                        let y = 0;
                        y < newRestaurants[i].categories.length;
                        y++
                    ) {
                        if (
                            newRestaurants[i].categories[y].name === newCateg[j]
                        ) {
